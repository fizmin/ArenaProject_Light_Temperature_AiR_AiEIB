...
public:
  ...
  */  
  ...
  /** Encrypt (AES-128bit ECB encryption mode) the @param input byte array and store the output in @param output. Use setKey() to set the key.
   *
   *  @param input byte array of length @param in_size
   *  @param output pointer to byte array to whitch cyphertext will be written
   *  @param out_size pointer to a variable to whitch output length will be written
  */ 
  void encryptBytes(byte *input, int8_t in_size, byte*output, int8_t *out_size);

  /** Decrypt (AES-128bit ECB encryption mode) the @param input byte array and store the output in @param output. Use setKey() to set the key.
   *
   *  @param input byte array of length @param in_size
   *  @param output pointer to byte array to whitch plainText will be written
   *  @param out_size pointer to a variable to whitch output length will be written
  */ 
  void decryptBytes(byte *input, int8_t in_size, byte*output, int8_t *out_size);
